...
1. **Pixels (px):**
    - Well, every is divided into number of small squares it like a grid.
    - Each square is known as "Pixel".
...
<img src="https://github.com/Amit-Ashok-Swain/Android-Kick-Off/blob/main/images/Understanding-View-and-ViewGroup-Objects/01.png" alt="Image Description" />
                                        ...
                                        <h3 align = "center">  Image Description: The example of Screen of Laptop and Tablet.</h3>
<p align="center">
<img src="https://github.com/Amit-Ashok-Swain/Android-Kick-Off/blob/main/images/Understanding-View-and-ViewGroup-Objects/01.png" alt="Image Description" />
</p>
                                        <h3 align = "center">  Image Description: The example of Screen of Laptop and Tablet with Grid.</h3>
<p align="center">
<img src="https://github.com/Amit-Ashok-Swain/Android-Kick-Off/blob/main/images/Understanding-View-and-ViewGroup-Objects/01.png" alt="Image Description" />
</p>
                                        <h3 align = "center">  Image Description: The example of single pixel grid.</h3>
<p align="center">
<img src="https://github.com/Amit-Ashok-Swain/Android-Kick-Off/blob/main/images/Understanding-View-and-ViewGroup-Objects/01.png" alt="Image Description" />
</p>
                                        <h3 align = "center">  Image Description: The example of pixels size varying for with different resolution.</h3>
<p align="center">
<img src="https://github.com/Amit-Ashok-Swain/Android-Kick-Off/blob/main/images/Understanding-View-and-ViewGroup-Objects/01.png" alt="Image Description" />
</p>
...
2. **Pixel Density (DPI):**
    ...
    - For example, an mdpi device with a screen width of 320 pixels will display a 320-pixel-wide element, while an xhdpi device with the same width will display a 480-pixel-wide element to maintain the same physical size.
...
4. **Scale-Independent Pixels (sp):**
   ...
   - We use 'dp' for defining the size of an image ot margins, etc.
